    ...
    <>
      ...
      <div style={{ marginTop: '34vw' }}>
        ...
        <FadeOnUp duration='1.5s'>
          <p style={{ fontSize: '1.5em' }}>
            ...
            that go into designing and developing a website. Whether it's making sure the user has a wonderful experience, or implementing effective algorithms,
      ...
      <hr />
        ...
        <Grid item sm={12} style={{marginLeft: '50px'}}>
          <img style={{ width: '10vw' }} src="https://coursereport-s3-production.global.ssl.fastly.net/uploads/school/logo/521/original/uwash.png" /><p>
