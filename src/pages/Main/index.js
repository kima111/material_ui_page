      ...
      <div style={{ marginTop: '34vw' }}>
        ...
        <Grid container spacing={2}>
          <Grid item sm={12} style={{ marginLeft: '50px' }}>
            <Icon link="https://bootcamp.uw.edu/coding/"><img alt="University of Washington Continuing Education Logo" style={{ width: '10vw', float: 'left', marginRight: '25px' }} src="https://coursereport-s3-production.global.ssl.fastly.net/uploads/school/logo/521/original/uwash.png" /></Icon>
          ...
          <hr />
          <Grid item sm={12} style={{ marginLeft: '50px' }}>
            <Icon link="https://www.cisco.com/c/en/us/training-events/training-certifications/certifications/professional/ccnp-routing-switching.html"><img alt="Cisco Certified Network Professional Logo" style={{ width: '10vw', float: 'left', marginRight: '25px' }} src="https://computingforgeeks.com/wp-content/uploads/2019/07/best-ccnp-rs-books.jpg" /></Icon>
            <p style={{ fontSize: '1.25em' }}>
          ...
          <hr />
          <Grid item sm={12} style={{ marginLeft: '50px' }}>
            <Icon link="https://docs.microsoft.com/en-us/learn/certifications/"><img alt="Microsoft IT Professional Logo" style={{ width: '10vw', float: 'left', marginRight: '25px' }} src="https://www.pngitem.com/pimgs/m/210-2108492_mcitp-logo-microsoft-certified-it-professional-hd-png.png" /></Icon>
            <p style={{ fontSize: '1.25em' }}>
