  ...
  return (
    <>
      ...
      <hr />
        ...
        <hr />
        <Grid item sm={12} style={{marginLeft: '50px'}}>
          <img style={{ width: '10vw', float: 'left', marginRight: '25px' }} src="https://computingforgeeks.com/wp-content/uploads/2019/07/best-ccnp-rs-books.jpg" />
          <p style={{fontSize: '1.5em'}}>
        ...
        <hr />
        <Grid item sm={12} style={{marginLeft: '50px'}}>
          <img style={{ width: '10vw', float: 'left', marginRight: '25px' }} src="https://www.pngitem.com/pimgs/m/210-2108492_mcitp-logo-microsoft-certified-it-professional-hd-png.png" />
          <p style={{fontSize: '1.5em'}}>
