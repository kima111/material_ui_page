  ...
  return (
    <>
      ...
      <Grid container spacing={2} justify="center">
        ...
        <Grid item lg={3} sm={6} xs={12} style={{textAlign: 'center', margin: '15px', paddingLeft: '25px'}}>
          <ProjectCard imageSource={P1Image} githubLink="https://github.com/kima111/bamazon" title="Bamazon" description="This is a Command Line Interface app which will work a lot like a purchasing terminal demonstrating the use of Node.js which is connected to a MySQL database."/>
        </Grid>
        <Grid item lg={3} sm={6} xs={12} style={{textAlign: 'center', margin: '15px', paddingLeft: '25px'}}>
